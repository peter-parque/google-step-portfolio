...
public final class FindMeetingQueryTest {
  ...
  // TESTS INCLUDING OPTIONAL ATTENDEES

  @Test
  public void ignoreOptionalAttendee() {
    // Have each person have different events, and the optional attendee have an all day event. 
    // We should see three options because each person has split the restricted times once, and 
  ...
  public void justEnoughRoomWithoutOptional() {
    // Have two people, one mandatory and one optional, but make it so there is only just enough 
    // room at one point in the day to have the meeting without the optional attendee.
    //
    // Events          : |--A--|     |----A----|
    // Optional Events :       |-B-|
    // Day             : |---------------------|
  ...
  public void onlyOptionalAttendeesWithGaps() {
    ...
    // split the restricted times once, and all optional attendees can attend.
    //
    // Events          :
    // Optional Events :       |--A--|     |--B--|
    // Day             : |-----------------------------|
  ...
  public void onlyOptionalAttendeesNoGaps() {
    ...
    // since the optional attendees cannot be accommodated and the mandatory ones (all zero of them) 
    // are free all day.
    //
    // Events          :
    // Optional Events : |----A----||----B-----|
